                        ...
                        <div class="card product-card border-0 shadow-sm h-100 d-flex flex-column transition hover-up">
                            <a href="index.php?page=product-detail&slug=<?php echo $product['slug']; ?>"
                                ...
                                <div class="position-relative product-img-container overflow-hidden bg-white">
                                    <?php
                                    $img_path = !empty($product['thumbnail']) ? 'admin/admin_images/' . $product['thumbnail'] : 'admin/admin_images/post_thumbnails/undefined.png';
                                    ?>
                                    <img class="card-img-top p-2 product-img-hover" src="<?php echo $img_path; ?>"
                                ...
                                <div class="card-body p-3 text-start d-flex flex-column flex-grow-1">
                                    <h6 class="fw-bold mb-2 text-dark line-clamp-2" style="min-height: 38px;">
                                        <?php
                                        $short_name = strip_tags($product['name']);
                                        echo (mb_strlen($short_name) > 37) ? mb_substr($short_name, 0, 37) . '...' : $short_name;
                                        ?>
                                    </h6>
                    ...
                    <ul class="pagination mb-0 border-0 d-flex flex-nowrap align-items-center">
                        ...
                        <li class="page-item <?php echo ($currentPage <= 1) ? 'disabled' : ''; ?>">
                            <a class="page-link border-0 rounded-circle mx-1 d-flex align-items-center justify-content-center custom-page-link"
                                href="<?php echo ($currentPage <= 1) ? '#' : 'index.php?page=' . $_GET['page'] . '&p=' . ($currentPage - 1); ?>"
                                aria-label="Previous">
                        ...
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                            <li class="page-item <?php echo ($i == $currentPage) ? 'active' : ''; ?>">
                                <a class="page-link border-0 rounded-circle mx-1 d-flex align-items-center justify-content-center custom-page-link"
                                    href="index.php?page=<?php echo $_GET['page']; ?>&p=<?php echo $i; ?>">
                                    <?php echo $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
                        ...
                        <li class="page-item <?php echo ($currentPage >= $totalPages) ? 'disabled' : ''; ?>">
                            <a class="page-link border-0 rounded-circle mx-1 d-flex align-items-center justify-content-center custom-page-link"
                                href="<?php echo ($currentPage >= $totalPages) ? '#' : 'index.php?page=' . $_GET['page'] . '&p=' . ($currentPage + 1); ?>"
                                aria-label="Next">
