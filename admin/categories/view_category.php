                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($get_category_result)) {
                        ...
                        if ($is_active) {
                            ...
                            echo "
                                        <a href='index.php?edit_category=$category_id' class='text-primary' title='Chỉnh sửa'>
                                            <i class='fas fa-edit'></i>
                                        </a>
                                        <a href='#' class='text-danger' data-bs-toggle='modal' data-bs-target='#delModal_$category_id' title='Xóa'>
